...
export SWE_EVAL_MAX_ATTEMPTS="${SWE_EVAL_MAX_ATTEMPTS:-2}"
export SWE_ROLLOUT_RETRIES="${SWE_ROLLOUT_RETRIES:-2}"
...
keys = (
    ...
    "SWE_AGENT_TIME_BUDGET_SEC", "SWE_EVAL_TIMEOUT_SEC", "SWE_EVAL_MAX_ATTEMPTS", "SWE_ROLLOUT_RETRIES", "SWE_ROLLOUT_RETRY_POLICY", "SWE_BOOT_CONCURRENCY",
